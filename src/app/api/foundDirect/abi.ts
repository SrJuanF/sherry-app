export const abi = [
  ...
  {
    type: "function",
    name: "changeMountLine",
    inputs: [
      { name: "newMountLine", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  { type: "error", name: "Raffle__MountLineNotReached", inputs: [] },
  { type: "error", name: "Raffle__OnlyOwnerCanChangeMountLine", inputs: [] },
